...
export const PostDeleting = createAction('[POST] Post Deleting Start', props<{ pid: string, sname: string, socialType: SocialType }>());
...
export const PostUpdating = createAction('[POST] Post Updating Start',
    props<{ post: any, sid: string, sname: string, socialType: 'BLOG' | 'FORUM' }>());
...
export const PostExpressing = createAction('[POST] Post Express Start', props<{ reaction: 'LIKE' | 'DISLIKE', pid: string, post: Post }>());
export const PostExpressed = createAction('[POST] Post Expressed Successfully', props<{ reaction: number, pid: string }>());
